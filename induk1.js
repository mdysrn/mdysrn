...
if ($(this).data('textformat') && typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== 'undefined') if ($(this).data('textformat') in AMAZINGSLIDER_TEXT_EFFECT_FORMATS) this.options = $.extend({
}, AMAZINGSLIDER_TEXT_EFFECT_FORMATS[$(this).data('textformat')], this.options);
if ($(this).data('skin') && typeof AMAZINGSLIDER_SKIN_OPTIONS !== 'undefined') if ($(this).data('skin') in AMAZINGSLIDER_SKIN_OPTIONS) this.options = $.extend({
}, AMAZINGSLIDER_SKIN_OPTIONS[$(this).data('skin')], this.options);
var instance = this;
$.each($(this).data(), function (key, value) {
...
var opacity_frames = 60 * options.fadeduration / 1000;
if (opacity_frames <= 0) opacity_frames = 1;
var opacity_inc = 1 / opacity_frames;
var scale_frames = 60 * options.duration / 1000;
